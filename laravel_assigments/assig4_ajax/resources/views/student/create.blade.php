...
<form class="col-md-6 offset-3" method="post" action="{{ url('/store') }}">
  ...
  <div class="form-group mt-3">
    ...
    <input type="text" class="form-control" name="phone_no" id="phone_no" aria-describedby="emailHelp" placeholder="Enter phone no">
  ...
  <br>
  <button type="submit" class="btn btn-success" id="addNewStudent">Save</button>
